...
# plugin
# add
complete -f -c asdf -n __fish_asdf_needs_command -a plugin -d "Change plugin"
complete -f -c asdf -n '__fish_asdf_using_command plugin; and __fish_asdf_arg_number 2' -a add -d "Add git repo as plugin"
complete -f -c asdf -n '__fish_asdf_using_command plugin; and __fish_asdf_using_command add; and __fish_asdf_arg_number 3' -a '(__fish_asdf_plugin_list_all | grep -v \'*\' | awk \'{ print $1 }\')'
complete -f -c asdf -n '__fish_asdf_using_command plugin; and __fish_asdf_using_command add; and __fish_asdf_arg_number 4' -a '(__fish_asdf_plugin_list_all | grep (__fish_asdf_arg_at 3) | awk \'{ print $2 }\')'
complete -f -c asdf -n '__fish_asdf_using_command plugin; and __fish_asdf_using_command add; and __fish_asdf_arg_number 5'
